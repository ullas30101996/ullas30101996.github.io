...
I possess full, unrestricted work authorization in the United Kingdom and do not require employer sponsorship.
...
* **Data Privacy & API Ingestion**: Implementing strict **SHA-256 cryptographic hashing** at the cloud firewall perimeter and building high-volume **FastAPI REST API gateways** for real-time telemetry.
...
* **Advanced ML Optimization**: Resolving extreme class imbalances using **SMOTE and Recursive Feature Elimination (RFE)**.
...
* **Carbon Footprint Analytics**: Building an **automated kg CO2e data-modeling framework** (parameterized for Greenly, Sterling, 2030 Calculator) to analyze the carbon impact of repair versus replacement.

**Commercialization, Dissemination & Impact**
* **Commercial**: Built a **Neutral Data Broker Model projected to cut warranty costs by 5%**; designed subscription scaling to capture 90% of UK manufacturers in 5 years.
...
* **Social & Economic**: Addressed the UK technician shortage by converting complex telemetry into a **standardized national training taxonomy**.
...
* Targeted the **smart city planning flaw** of isolated, siloed modelling, which left asset management teams blind to systemic cross-asset degradation.
...
* Implemented joint **exploratory analysis and rigorous feature engineering** using **Variance Inflation Factor (VIF)** and diagnostic PCA, **contracting the feature space by ~40%**.
* Built imbalance-aware predictive models using **Random Forest and XGBoost**, optimized for failure recall and macro F1-scores.
...
* Empowered civil asset-management organizations and municipal smart city planners with **data-driven decision capabilities**.
* **Reduced manual data preparation efforts by ~60%** and **accelerated software prototyping throughput by ~70%** via strategic LLM-assisted development.
* Shifted urban decision-making from reactive, single-asset repairs to **risk-informed, system-level proactive maintenance planning**, significantly decreasing unplanned emergency repair costs.
...
* **Curriculum Innovation**: Bridged the pedagogical gap between abstract theory and field application by recontextualizing engineering mathematics into real-world smart city infrastructure use cases.
* **Technical Mentorship**: Led laboratory sessions across **6+ core technical modules**, including IoT Applications, Embedded C Programming, and Digital Electronics.
* **Educational Impact**: **Boosted average student technical project performance and laboratory marks by ~20%** through interactive tutorials and refined workflows.
* **Scale of Influence**: Supported **100+ undergraduate and postgraduate engineering students** in developing industry-ready technical competencies.
* **Professional Recognition**: Cultivated an inclusive learning atmosphere that earned a formal university **HEFI Teaching Impact Award**.
* **Standards Alignment**: Formally aligned teaching methodologies with the **UK Professional Standards Framework (UKPSF)**, securing **AFHEA Teaching Certification**.
...
* Engineered **zero-fault software** for **safety-critical Electronic Control Units (ECUs)** governing active vehicle stability and hybrid powertrains.
...
* Programmed and configured **Diagnostic Communication Manager (DCM) modules** in Embedded C, implementing **OBD and UDS diagnostic messaging protocols** within a **Classic AUTOSAR** software stack.
* Engineered **automated ECU test benches** utilizing CAPL and LabVIEW and established **automated Jenkins CI/CD validation pipelines**.
* Debugged hardware-to-software signal boundaries using **JTAG interfaces** and utilized SQL for querying diagnostic datasets.
* **Slashed automated regression validation overhead times by 40%** via script-driven test benches.
* **Shortened overall software deployment and release cycles by ~25%**, directly enabling aggressive international OEM production timelines.

---

### Project Trainee - CAN Bus Configuration Management for Active Safety ECUs
**Robert Bosch Engineering and Business Solutions Pvt. Ltd, India** | July 2019 – May 2020

* Resolved critical signal discrepancies by **re-architecting multi-layered network communication stacks (COM and SCL layers)**.
* Configured and programmed **CAN, CAN FD, and FlexRay protocol layers** to ensure high-bandwidth, real-time compliance within a **Classic AUTOSAR** environment.
* Engineered comprehensive **Hardware-in-the-Loop (HIL) and Software-in-the-Loop (SIL) simulation frameworks** to validate ECU behavior under real-world conditions.
* Developed high-fidelity **CAPL and LabVIEW automation suites** for continuous integration.
* **Slashed vehicle software system development cycles by 15%** by automating manual verification workflows.

---

### Project Intern - Combat & Engine Systems Modelling
**Hindustan Aeronautics Limited (HAL), Bengaluru, India** | January 2017
